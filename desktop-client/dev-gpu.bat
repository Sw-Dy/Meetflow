@echo off
REM MeetFlow GPU-Accelerated Development Script for Windows
...
echo.
echo ========================================
echo   MeetFlow GPU-Accelerated Development
echo ========================================
echo.
...
echo.
echo 📦 Starting MeetFlow in development mode...
echo.

REM Find package.json location
if exist "package.json" (
    echo    Found package.json in current directory
) else if exist "desktop-client\package.json" (
    echo    Found package.json in desktop-client directory
    cd desktop-client
) else (
    echo    ❌ Error: Could not find package.json
    echo    Make sure you're in the project root or desktop-client directory
    exit /b 1
)
...
set "HELPER_DIR=..\local-llm-helper"
...
echo.
echo ========================================
echo   MeetFlow GPU Development Script - Help
echo ========================================
echo.
echo USAGE:
...
echo   MeetFlow in development mode with optimal hardware acceleration:
echo.
