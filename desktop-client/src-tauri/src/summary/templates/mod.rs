...
//! # Architecture
//!
//! - **Built-in templates**: JSON files in `desktop-client/src-tauri/templates/` embedded at compile time
...
//! - macOS: `~/Library/Application Support/MeetFlow/templates/`
//! - Windows: `%APPDATA%\MeetFlow\templates\`
//! - Linux: `~/.config/MeetFlow/templates/`
//!
