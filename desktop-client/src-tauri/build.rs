...
fn main() {
    ...
    #[cfg(target_env = "msvc")]
    {
        // ONNX Runtime ships C++ objects. The Rust MSVC target links the C
        // runtime automatically, but the C++ runtime is needed for libort_sys.
...
fn detect_and_report_gpu_capabilities() {
    ...
    println!("cargo:warning=🚀 Building MeetFlow for: {}", target_os);
