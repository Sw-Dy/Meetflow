...
**MeetFlow** is a privacy-first AI meeting assistant that captures, transcribes, and summarizes meetings entirely on local infrastructure. The supported application is the Tauri desktop app with a Rust core.
...
│  (desktop-client/src-tauri/src/audio/pipeline.rs)                │
└─────────────┬──────────────────────────┬───────────────────┘
              ↓                          ↓
    ┌─────────────────┐        ┌─────────────────────┐
...
- **Development**: `desktop-client/models/`
- **Production (macOS)**: `~/Library/Application Support/MeetFlow/models/`
- **Production (Windows)**: `%APPDATA%\MeetFlow\models\`

**Model Loading** (desktop-client/src-tauri/src/whisper_engine/whisper_engine.rs):
```rust
...
**Location**: `desktop-client/src-tauri/src/audio/pipeline.rs`
...
Current app behavior should be implemented in the Rust/Tauri core, not in the archived Python backend. Add new frontend-facing behavior through Tauri commands/events and existing Rust services under `desktop-client/src-tauri/src`.
...
**Core Coordination**:
- [desktop-client/src-tauri/src/lib.rs](desktop-client/src-tauri/src/lib.rs) - Main Tauri entry point, command registration
- [desktop-client/src-tauri/src/audio/mod.rs](desktop-client/src-tauri/src/audio/mod.rs) - Audio module exports
- [desktop-client/src-tauri/src/database/mod.rs](desktop-client/src-tauri/src/database/mod.rs) - Local database module

**Audio System**:
- [desktop-client/src-tauri/src/audio/recording_manager.rs](desktop-client/src-tauri/src/audio/recording_manager.rs) - Recording orchestration
- [desktop-client/src-tauri/src/audio/pipeline.rs](desktop-client/src-tauri/src/audio/pipeline.rs) - Audio mixing and VAD
- [desktop-client/src-tauri/src/audio/recording_saver.rs](desktop-client/src-tauri/src/audio/recording_saver.rs) - Audio file writing

**UI Components**:
- [desktop-client/src/app/page.tsx](desktop-client/src/app/page.tsx) - Main recording interface
- [desktop-client/src/components/Sidebar/SidebarProvider.tsx](desktop-client/src/components/Sidebar/SidebarProvider.tsx) - Global state management

**Whisper Integration**:
- [desktop-client/src-tauri/src/whisper_engine/whisper_engine.rs](desktop-client/src-tauri/src/whisper_engine/whisper_engine.rs) - Whisper model management and transcription
