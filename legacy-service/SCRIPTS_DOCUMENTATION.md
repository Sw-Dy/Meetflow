...
MeetFlow no longer uses these backend scripts for supported development or user
setup. The supported app is the Tauri desktop application under `desktop-client/`,
with Rust backend code in `desktop-client/src-tauri`.
